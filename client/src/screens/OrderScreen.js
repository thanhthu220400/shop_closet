...
const OrderScreen = ({ match }) => {
  ...
  if (!loading) {
    ...
    order.shippingPrice = addDecimals(order.imtemsPrice > 300 ? 0 : 30);

    order.taxPrice = addDecimals(Number((0.05 * order.imtemsPrice).toFixed(2)));
                ...
                <div className="row">
                  ...
                  <div className="col-md-8 center">
                    ...
                    <p>
                      ...
                      {order.shippingAddress.city}, Số điện thoại: {""}
