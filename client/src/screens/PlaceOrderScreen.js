...
const PlaceOrderScreen = ({ history }) => {
  ...
  cart.taxPrice = addDecimals(Number((0.05 * cart.imtemsPrice).toFixed(2)));
            ...
            <table className="table table-bordered">
              <tbody>
                <tr>
                  ...
                  <td>VND {cart.imtemsPrice}</td>
                </tr>
                <tr>
                  <td>
                    <strong>Phí ship</strong>
                  </td>
                  <td>VND {cart.shippingPrice}</td>
                </tr>
                <tr>
                  <td>
                    <strong>GTGT</strong>
                  </td>
                  <td>VND {cart.taxPrice}</td>
                </tr>
                <tr>
                  <td>
                    <strong>Tổng cộng</strong>
                  </td>
                  <td>VND {cart.totalPrice}</td>
                </tr>
              </tbody>
            </table>
